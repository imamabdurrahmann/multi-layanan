  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {isOpen && (
        <div className="flex flex-col gap-2 animate-fade-in">
          <a
            ...
            className="flex items-center gap-2 px-4 py-3 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group"
          >
            ...
            <div>
              <p className="text-sm font-semibold text-gray-800">WhatsApp 1</p>
              <p className="text-xs text-gray-500">082133100565</p>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-gray-800">WhatsApp 2</p>
              <p className="text-xs text-gray-500">081381801565</p>
            </div>
          </a>
        </div>
      )}
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
