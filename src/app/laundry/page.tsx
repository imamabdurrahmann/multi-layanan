      ...
      <section className="section section-alt">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="section-header text-center mb-12">
            ...
            <h2 className="section-title mt-2">Mengapa Memilih Layanan Laundry Kami?</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <article className="card p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-[var(--text-dark)] mb-2">Hasil Berkualitas</h3>
            ...
            <article className="card p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-[var(--text-dark)] mb-2">Standar Higienis</h3>
              <p className="text-sm text-[var(--text-secondary)]">
            ...
            <article className="card p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-[var(--text-dark)] mb-2">Tepat Waktu</h3>
              <p className="text-sm text-[var(--text-secondary)]">
      ...
      <section className="section">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="section-header">
            ...
            <h2 className="section-title mt-2">Klien yang Telah Kami Layani</h2>
