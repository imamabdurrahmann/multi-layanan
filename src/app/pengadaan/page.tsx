      ...
      <section className="hero-section py-16 md:py-20">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-16 w-full text-center relative z-10">
          <div className="py-20 md:py-32">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">Pengadaan Barang</h1>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[var(--text-dark)] mb-6">Pengadaan Barang Profesional</h2>
      ...
      <section className="section-alt">
        <div className="max-w-6xl mx-auto px-6 lg:px-16">
          <div className="section-header text-center mb-12">
            <span className="text-sm font-semibold tracking-wider text-[var(--primary)] uppercase mb-3 block">Kategori Produk</span>
            <h2 className="section-title">Kategori Produk dan Layanan</h2>
          </div>

          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            {productCategories.map((category, index) => (
              <article key={index} className="card p-6 md:p-8">
                ...
                <ul className="space-y-3">
                  {category.features.map((feature, fIndex) => (
                    <li key={fIndex} className="flex items-start gap-3 text-sm text-[var(--text-secondary)]">
      ...
      <section className="section-alt">
        <div className="max-w-6xl mx-auto px-6 lg:px-16">
          <div className="max-w-2xl mx-auto text-center py-16 md:py-20">
            <h2 className="text-2xl md:text-3xl font-bold text-[var(--text-dark)] mb-4">Butuh Pengadaan Barang untuk Organisasi Anda?</h2>
