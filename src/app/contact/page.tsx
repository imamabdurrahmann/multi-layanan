      ...
      <section className="hero-section py-16 md:py-20">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-16 w-full relative z-10">
          <div className="text-center py-20 md:py-32">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">Hubungi Kami</h1>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-[var(--primary)] to-[var(--primary-light)] rounded-2xl p-8 text-white">
              ...
              <h3 className="text-lg font-bold mb-3">Kantor Kami</h3>
            ...
            {/* Card 2 - WhatsApp */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-[var(--bg-gray)]">
              <div className="w-12 h-12 rounded-xl bg-[#25D366]/10 flex items-center justify-center mb-4">
                <Phone size={24} className="text-[#25D366]" />
              </div>
              <h3 className="text-lg font-bold text-[var(--text-dark)] mb-3">WhatsApp</h3>
              <div className="space-y-4">
                <a
                  href={`https://wa.me/${companyInfo.whatsapp1}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-sm text-[#25D366] font-semibold hover:gap-4 transition-all"
                >
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-[var(--bg-gray)]">
              ...
              <h3 className="text-lg font-bold text-[var(--text-dark)] mb-3">Email</h3>
              <p className="text-base font-semibold text-[var(--text-dark)] mb-4">
                {companyInfo.email}
              </p>
              <a
                href={`mailto:${companyInfo.email}`}
                className="inline-flex items-center gap-2 text-sm text-[var(--primary)] font-semibold hover:gap-3 transition-all"
              >
                Kirim Email
                <ArrowRight size={18} />
              </a>
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-16">
            ...
            <div>
              <span className="text-sm font-semibold tracking-wider text-[var(--primary)] uppercase mb-3 block">
                Hubungi Kami
              </span>
              <h2 className="text-2xl md:text-3xl font-bold text-[var(--text-dark)] mb-6">Siap Membantu Anda</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  <Link href="/pengadaan" className="flex items-center gap-3 p-4 md:p-6 bg-[var(--bg-light)] rounded-xl hover:shadow-md transition-all">
                    <div className="w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center">
                      <span className="text-blue-500 font-bold">P</span>
                    </div>
                    <span className="text-sm font-medium">Pengadaan Barang</span>
                  </Link>
                  <Link href="/konstruksi" className="flex items-center gap-3 p-4 md:p-6 bg-[var(--bg-light)] rounded-xl hover:shadow-md transition-all">
                    <div className="w-10 h-10 rounded-lg bg-orange-500/10 flex items-center justify-center">
                      <span className="text-orange-500 font-bold">K</span>
                    </div>
                    <span className="text-sm font-medium">Konstruksi</span>
                  </Link>
                  <Link href="/travel" className="flex items-center gap-3 p-4 md:p-6 bg-[var(--bg-light)] rounded-xl hover:shadow-md transition-all">
                    <div className="w-10 h-10 rounded-lg bg-teal-500/10 flex items-center justify-center">
                      <span className="text-teal-500 font-bold">T</span>
                    </div>
                    <span className="text-sm font-medium">Travel</span>
                  </Link>
                  <Link href="/laundry" className="flex items-center gap-3 p-4 md:p-6 bg-[var(--bg-light)] rounded-xl hover:shadow-md transition-all">
            ...
            {/* Right - Contact Form */}
            <div className="bg-[var(--bg-light)] rounded-2xl p-6 md:p-8 lg:p-10">
